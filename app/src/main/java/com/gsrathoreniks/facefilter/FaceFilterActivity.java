...
public class FaceFilterActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        hideStatusBar(this.getWindow(), true);
        ...
        ImageButton faceMask = (ImageButton) findViewById(R.id.facMask);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Toast.makeText(FaceFilterActivity.this, "Camera Facing", Toast.LENGTH_SHORT).show();
                if (CAMERA_FACING == CameraSource.CAMERA_FACING_BACK) {
                    CAMERA_FACING = CameraSource.CAMERA_FACING_FRONT;
                } else {
